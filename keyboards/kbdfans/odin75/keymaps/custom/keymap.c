...
const uint16_t PROGMEM keymaps[2][MATRIX_ROWS][MATRIX_COLS] = {
  [_BL] = LAYOUT(
    KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_MUTE,  KC_PSCR, KC_HOME,
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,          MO(_FL), KC_UP,
    KC_LCTL, KC_LGUI, KC_LALT,                           KC_SPC,                                       KC_RALT, KC_RCTL, KC_LEFT,  KC_DOWN, KC_RGHT
  ),

  [_FL] = LAYOUT(
    KC_TRNS,  KC_BRID, KC_BRIU, KC_MCTL, KC_SLEP, KC_CALC, KC_BRMD, KC_BRMU, KC_FIND, KC_MRWD, KC_MPLY, KC_VOLD, KC_VOLU, KC_TRNS,  KC_TRNS, KC_TRNS,
